<template>
  ...
  <div class="search-container form-outline">
    <input class="form-control" id="search" type="text"
      placeholder="Search Project with Title Description and Manager Name" v-model="searchTerm"
      @input="searchOrganization">
    <button id="reset" @click="clearSearch">Clear</button>
  </div>
  <base-dialog :show="viewForm" title="Edit Project Info" @close="handleProject">
        ...
        <tr v-for="project in filteredProjects" :key="project.id">
          ...
          <td>
            <div class="progress">
              ...
              <div :class="backgroundChange(project.tasks_completed, project.total_tasks)" role="progressbar"
                aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" :style="
                  'width:' +
                  parseInt(
